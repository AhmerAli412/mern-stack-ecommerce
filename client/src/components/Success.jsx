...
const Success = () => {
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div class="flex flex-col items-center">
      ...
      <Link to="/" class="mb-8 inline-flex items-center gap-2.5 text-2xl font-bold text-black md:text-3xl" aria-label="logo">
      ...
      <h1 class="mb-2 text-center text-2xl font-bold text-gray-800 md:text-3xl">Payment Successfull</h1>

      <p class="mb-12 max-w-screen-md text-center text-gray-500 md:text-lg">Payment Successfull</p>
